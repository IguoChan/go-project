...
/*
Package simplepb is a reverse proxy.
...
func RegisterSimpleHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SimpleServer) error {
	...
	mux.Handle("POST", pattern_Simple_Route_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/simplepb.Simple/Route", runtime.WithHTTPPathPattern("/v1/demo/cyg"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Simple_Route_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterSimpleHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SimpleClient) error {
	...
	mux.Handle("POST", pattern_Simple_Route_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/simplepb.Simple/Route", runtime.WithHTTPPathPattern("/v1/demo/cyg"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Simple_Route_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Simple_Route_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "demo", "cyg"}, ""))
)
